...
public:
    virtual void prepare() = 0; // pure virtual method
    virtual ~GarlicBread() {}        // Destructor
};

// Concreate class of GarlicBread of Singh type
...
// Concreate class of GarlicBread of King type
...
int main()
{
    ...
    Factory *myFactory = new KingBurger();
